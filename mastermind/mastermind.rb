module Helpers
  PHRASE_ARR = ["Give me your best shot", "Shoot a guess","Lets try to break it", "Show me your hacking skill bro","Try me"]
  COMP_PHRASE_ARR = ["That was easy, try harder", "Is that all you got ?", "Easy peasy, lemon squeezy","Winner winner, chicken dinner"]
...
class Decoder
  ...
  def set_guess
    puts "#{PHRASE_ARR[rand(4)]}, give me 4 digit"
    guess = gets.chomp
...
def play_codemaker
  ...
  if guessed 
    puts "#{COMP_PHRASE_ARR[rand(4)]}"
    puts "\n"
  else
    puts "WHAK WHAAAK WHAAAAAAK, I'll try hardere next time"
    puts "\n"
  end
...
## Live Repl https://repl.it/@Jaybur1/Mastermind
